    ...
    <div className="space-y-6 md:space-y-8 pt-12 px-0 mx-[-6px]">
      ...
      <section className="relative h-[400px] md:h-[500px] rounded-xl overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: "linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('https://ikrytonian.sirv.com/headerbanner.jpg')",
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        <div className="p-6 rounded-xl shadow-lg text-center font-semibold text-white"
             style={{
              backgroundImage: "linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('https://ikrytonian.sirv.com/bg8.jpg')",
              backgroundSize: 'cover',
              backgroundPosition: 'center',
             }} >
        ...
        <div className="p-6 rounded-xl shadow-lg text-center text-white"
             style={{
              backgroundImage: "linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('https://ikrytonian.sirv.com/bg9.jpg')",
              backgroundSize: 'cover',
              backgroundPosition: 'center',
             }} >
        ...
        >
          <div className=" absolute inset-0 border-8 border-pink-700 rounded-lg"
               style={{
                backgroundImage: "linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('https://ikrytonian.sirv.com/bg7.jpg')",
                backgroundSize: 'cover',
                backgroundPosition: 'center',
               }}></div>
      ...
      <section 
        className="p-6 md:p-12 rounded-xl text-white text-center"
          style={{
            backgroundImage: "linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://ikrytonian.sirv.com/bg5.jpg')",
            backgroundSize: 'cover',
            backgroundPosition: 'center',
          }}
      >
